...
const LikeButton = forwardRef(({ likeableId, likeableType, initialLikesCount, initialIsLiked }, ref) => {
    ...
    return (
        <div className="flex items-center space-x-2 mt-2">
            ...
            >
                <svg
                    ...
                    className={`h-5 w-5 mr-1 transition-transform duration-300 ${
                        isLiked ? 'text-blue-500 dark:text-blue-400' : 'text-gray-500 dark:text-gray-300' 
            ...
            <span className="text-base font-semibold text-gray-500 dark:text-white">{likesCount}</span>
        </div>
    );
});
